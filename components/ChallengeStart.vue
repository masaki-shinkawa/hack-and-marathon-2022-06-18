<template>
  <div class="n-container">
    ...
    <div class="memberCardList">
      <MemberCard name="aaaaa" :status="1" :metre="10.1"></MemberCard>
      <MemberCard name="aaaaa" :status="2" :metre="1.0"></MemberCard>
      <MemberCard name="aaaaa" :status="3" :metre="10.1"></MemberCard>
    </div>
    ...
    <v-btn class="mt-4" large block style="background-color: white;" rounded outlined color="primary" @click="end">
      今日はここまで
    </v-btn>
  </div>
</template>
